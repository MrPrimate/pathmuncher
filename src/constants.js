...
const CONSTANTS = {
  ...
  CORE_COMPENDIUM_MAPPINGS: {
    ...
    ancestryFeatures: [
      ...
      "sf2e.ancestry-features",
      "sf2e-anachronism.ancestry-features",
      "pf2e-anachronism.ancestry-features",
    ...
    deities: [
      "pf2e.deities",
      "sf2e.deities",
      "sf2e-anachronism.deities",
      "pf2e-anachronism.deities",
      "pf2e-legacy-content.deities-legacy",
    ],
    backgrounds: [
      "pf2e.backgrounds",
      "sf2e.backgrounds",
      "sf2e-anachronism.backgrounds",
      "pf2e-anachronism.backgrounds",
      "pf2e-legacy-content.backgrounds-legacy",
    ],
  },
